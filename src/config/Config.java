...
public class Config {
	...
	public static final String CWD = System.getProperty("user.dir") + File.separator; // File.separator + "home" + File.separator + "pi" + File.separator + "ReportTime" + File.separator
